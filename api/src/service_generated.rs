...
impl<'a> Message<'a> {
    ...
    pub fn mtype(&self) -> MessageType {
        self._tab
            .get::<MessageType>(Message::VT_MTYPE, Some(MessageType::GETLIST))
            .unwrap()
    }
    #[inline]
...
impl<'a: 'b, 'b> MessageBuilder<'a, 'b> {
    ...
    pub fn add_mtype(&mut self, mtype: MessageType) {
        self.fbb_
            .push_slot::<MessageType>(Message::VT_MTYPE, mtype, MessageType::GETLIST);
    }
    #[inline]
    pub fn add_members(
        &mut self,
        ...
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(Message::VT_MEMBERS, members);
    }
    #[inline]
